# AGENTS – The Joseph Carlson Show Stock Tracker

This repo contains a small, static web app for tracking **dividend and growth stocks** featured on The Joseph Carlson Show via a scoring framework.

## Purpose

- Render a table of stocks featured on The Joseph Carlson Show with:
...
- `index.html` – The Joseph Carlson Show branded UI shell (hero, legend, table container).
...
- `README.md` – Contains the prompt template for generating structured stock JSON for stocks featured on The Joseph Carlson Show.
